...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<h2 style="padding-left: 30px; padding-top: 25px;">구매요청 현황</h2>

<div id="searchUI" style="padding-left: 30px; padding-top: 10px;">	<!-- 검색 -->
	<!-- 탭 -->
	...
	<div class="input-group mb-3">
		<div style="margin:auto 5px;">작성일자 :</div>  
		<input type="date" name="doc_date"/><div style="margin:auto 5px;">~</div><input type="date" name="doc_dateEnd" style="margin-right:15px;"/>
		<div style="margin:auto 5px;">작성자명 :</div> 
		<div class="input-group-prepend" style="margin-left:5px;">
			<input type="button" id="empBtn" value="찾기" class="btn btn btn-outline-secondary"/>
		</div>
		<input type="text" name="emp_no" id="empNo" readonly/>
...
<input type="button" id="delBtn" class="btn btn-outline-danger" value="삭제" style="display:none; margin-left:30px;"/>
