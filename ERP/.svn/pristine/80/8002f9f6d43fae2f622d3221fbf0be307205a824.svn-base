...
<head>
	...
	<link rel="stylesheet" href="${cPath}/resources/css/error/error_denied.css">
</head>
<body>
	...
	<div class="container">
		<div class="left-section">
			<div class="inner-content">
				<h1 class="heading">접근제한</h1>
				<p class="subheading">Oops! Something went wrong.</p>
				
				<button class="error__button error__button--active" onclick="window.history.back();" style="margin-left: 50px;">Back</button>
  				<button class="error__button error__button--active" onclick="window.location.href='${cPath}/main'">Main</button>
			</div>
		</div>
