...
@Controller
@RequestMapping("/order/buyer/{buyer_no}")
public class OR_BuyerModifyController {
	@Inject
	...
	public String update(@Validated(UpdateGroup.class) @ModelAttribute BuyerVO buyer
		...
		if(!errors.hasErrors()) {
			...
			case FAIL:
				...
				goPage = "redirect:/order/buyer/{buyer_no}/form";
				break;
			default:
				goPage = "redirect:/order/buyer/buyerList";
				break;
			}
		}else {
			goPage = "redirect:/order/buyer/{buyer_no}/form";
	...
	public String delete(@ModelAttribute("buyer") BuyerVO buyer, BindingResult errors,
		...
		if (!errors.hasErrors()) {
			...
			case FAIL:
				...
				goPage = "redirect:/order/buyer/{buyer_no}";
				break;
			default: // OK
				goPage = "redirect:/order/buyer/buyerList";
				break;
