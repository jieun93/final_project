...
<table class="table table-bordered  text-left">	
	<!-- <tbody id="listBody2"> -->
		...
		<tr>
			<td><input type="text" class="sal_date_start form-control" style="width: 200px;" readonly/>  ~ <input type="text" class="sal_date_end form-control" style="width: 200px;" readonly/></td>
