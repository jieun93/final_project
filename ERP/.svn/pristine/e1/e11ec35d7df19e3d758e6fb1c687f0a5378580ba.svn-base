    ...
    <div class="container">
        ...
        <div id="contextMenu" class="dropdown clearfix">
            <ul class="dropdown-menu dropNewEvent" role="menu" aria-labelledby="dropdownMenu"
                ...
                <li><a tabindex="-1" href="${cPath }/resources/a.jsp">카테고리1</a></li>
                <li><a tabindex="-1" href="${cPath }/resources/a.jsp">카테고리2</a></li>
                <li><a tabindex="-1" href="${cPath }/resources/a.jsp">카테고리3</a></li>
                <li><a tabindex="-1" href="${cPath }/resources/a.jsp">카테고리4</a></li>
                <li class="divider"></li>
                <li><a tabindex="-1" href="${cPath }/resources/a.jsp" data-role="close">Close</a></li>
            </ul>
        </div>
