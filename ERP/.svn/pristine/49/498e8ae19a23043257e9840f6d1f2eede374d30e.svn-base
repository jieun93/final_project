...
<h2 style="padding-left: 30px; padding-top: 25px;">원자재 등록</h2>
		...
		<table class="table">
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" class="btn btn-info" value="목록으로 " onclick="location.href='${pageContext.request.contextPath}/ware/mat/list';"/>
