  ...
  <!-- Left navbar links -->
   <ul class="navbar-nav topUl">
    ...
    <li class="nav-item d-none d-sm-inline-block" data-url="/emp">
      <a href="${cPath }/emp/manage/empList" class="nav-link" style="font-size:12pt; margin:0 0 0 5px">
    ...
    <li class="nav-item d-none d-sm-inline-block" data-url="/buy">
       <a href="${cPath }/buy/document" class="nav-link" data-url="/buy" style="font-size:12pt; margin:0 0 0 5px">
