...
<div>
					...
					<button style="float:right; margin: 0 55px 15px 0 " class="btn btn-success">퇴직정산</button>
					</a>
</div>
...
<div class="form-inline d-flex ml-md-auto d-print-none middleDiv" id="searchUI">		
			...
			<tr> 
				...
				<th>정산구분</th>
				<td>
				<select class="dynamicElement form-control mr-2" name="retire_reason"> 
				...
				<td><input type="submit" class="btn btn-primary " value="검색" id="searchBtn"></td>
