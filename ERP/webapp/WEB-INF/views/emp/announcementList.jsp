...
<div style="float:right; margin: 0 50px 0 0;">
			<%-- 	<a href="<c:url value='/emp/manage/ann/announcementNewUpdate'/>">
						...
						<button onclick="location.href='${cPath}/emp/manage/ann/announcementNewUpdate'"  style="align:right" class="btn btn-success">신규발령</button>
	</div>
	...
	<thead class="">
		<tr class="row">
			<td class="col-2 form-inline"><select
				class="dynamicElement form-control" name="dep_no2"
		...
		<tr class="row">
			<td class="col-2 form-inline"><select
				class="dynamicElement form-control" name="dep_no"
		...
		<tr class="row">
			<td class="col-2 form-inline"><select
				class="dynamicElement  form-control" name="ann_status"
				data-url="<c:url value='/emp/manage/annList'/>">
					<option value="">발령상태</option>
			</select></td>
		</tr>
		<tr class="row">
			<td class="col-8"><input type="submit"  class="btn btn-primary"  value="검색" id="searchBtn"></td>
		</tr>
	</thead>
</div>
...
<div  class='middleDiv'>
		<button class="btn btn-outline-info up" data-no='B002' >발령완료</button> 
		<button	class="btn btn-outline-info up" data-no='B003' >발령취소</button> 
</div>
<input type="hidden" name="page" value="${param.page }" />
...
<form action="${cPath}/emp/manage/ann" id="upform">
	...
	<input type="hidden" name="ann_date" id="time" value="${emp.ann_date }">
