...
<div class="tab-content" style="
  ...
  data-detail-formatter="detailFormatter"
   ...
   >
  <thead style="border-color: #7abaff; background-color: #b8daff">
    <tr>
...
function operateFormatter(value, row, index) {
  ...
  window.operateEvents = {
    'click .like': function (e, value, row, index) {
     sendval = row
     console.log(row)
     let openWin = window.open("${cPath}/enter/buyorder/"+ code + "/" + lstore + "/" + row.stuff_key  +"/insert", "네이버새창", "width=1300, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=no" )
