...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-xl">
    <div class="modal-content">
      ...
      <select id = "Lwarelist"  class="dynamicElement form-control col-md-6" data-url = "${cPath }/ware/warehouse/lwarelist" name = "search.searchType">
...
<option value ="">창고선택</option>
        ...
        <iframe src="${cPath}/ware/warehouse/shape" width="900px" height="400px" id = "storeBox" ></iframe>
        <div>
        	<form id = "dis">
        	<table class = "table">
        	<thead>
...
function OrderFirm(event){
	...
	let path = "${cPath}/ware/disuse/app/regist"
	...
	$("#Lwarelist").val("")
	$("#wareList").val("")
	$("#storeBox").attr("src","${cPath}/ware/warehouse/shape")
	$("#sectorbody").html("")
}
