...
<script type="text/javascript">
	...
	//매입서 등록
	$("#insertPurBtn").click(function(){
		if($("input[class=listCheck]:checked").length < 1){		//유효성 검사
			alert("매입할 목록을 체크해주세요.");
			return false;
		}
		let idx = 0;
        ...
        let ac_socketMsg = "회계부서 매입서 등록 완료 ";
        let wh_socketMsg = "자재부서 매입서 등록 완료 ";
//         console.log("msgmsg : " + socketMsg);
        socket.send(ac_socketMsg);
        socket.send(wh_socketMsg);
